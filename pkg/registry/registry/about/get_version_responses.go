...
func (o *GetVersionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /about] getVersion", response, response.Code())
	}
}
...
func (o *GetVersionOK) Error() string {
	return fmt.Sprintf("[GET /about][%d] getVersionOK  %+v", 200, o.Payload)
}
