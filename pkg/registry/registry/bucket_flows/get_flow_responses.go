...
func (o *GetFlowReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 409:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /buckets/{bucketId}/flows/{flowId}] getFlow", response, response.Code())
	}
}
...
func (o *GetFlowOK) Error() string {
	return fmt.Sprintf("[GET /buckets/{bucketId}/flows/{flowId}][%d] getFlowOK  %+v", 200, o.Payload)
}
...
func (o *GetFlowBadRequest) Error() string {
	return fmt.Sprintf("[GET /buckets/{bucketId}/flows/{flowId}][%d] getFlowBadRequest ", 400)
}
...
func (o *GetFlowUnauthorized) Error() string {
	return fmt.Sprintf("[GET /buckets/{bucketId}/flows/{flowId}][%d] getFlowUnauthorized ", 401)
}
...
func (o *GetFlowForbidden) Error() string {
	return fmt.Sprintf("[GET /buckets/{bucketId}/flows/{flowId}][%d] getFlowForbidden ", 403)
}
...
func (o *GetFlowNotFound) Error() string {
	return fmt.Sprintf("[GET /buckets/{bucketId}/flows/{flowId}][%d] getFlowNotFound ", 404)
}
...
func (o *GetFlowConflict) Error() string {
	return fmt.Sprintf("[GET /buckets/{bucketId}/flows/{flowId}][%d] getFlowConflict ", 409)
}
