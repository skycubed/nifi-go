...
func (o *GetBundlesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 401:
		result := NewGetBundlesUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /bundles] getBundles", response, response.Code())
	}
}
...
// Code gets the status code for the get bundles unauthorized response
func (o *GetBundlesUnauthorized) Code() int {
	return 401
}
...
func (o *GetBundlesUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
