...
func (o *UpdateConnectionParams) WithBody(body *models.ConnectionEntity) *UpdateConnectionParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update connection params
func (o *UpdateConnectionParams) SetBody(body *models.ConnectionEntity) {
	o.Body = body
}
