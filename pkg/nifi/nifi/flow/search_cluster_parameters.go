...
// WithDefaults hydrates default values in the search cluster params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SearchClusterParams) WithDefaults() *SearchClusterParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the search cluster params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SearchClusterParams) SetDefaults() {
