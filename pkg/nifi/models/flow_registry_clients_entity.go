...
func (m *FlowRegistryClientsEntity) validateRegistries(formats strfmt.Registry) error {
...
func (m *FlowRegistryClientsEntity) contextValidateRegistries(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FlowRegistryClientsEntity) UnmarshalBinary(b []byte) error {
	var res FlowRegistryClientsEntity
