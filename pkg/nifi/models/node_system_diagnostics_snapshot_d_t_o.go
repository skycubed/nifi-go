...
func (m *NodeSystemDiagnosticsSnapshotDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NodeSystemDiagnosticsSnapshotDTO) validateSnapshot(formats strfmt.Registry) error {
...
func (m *NodeSystemDiagnosticsSnapshotDTO) contextValidateSnapshot(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NodeSystemDiagnosticsSnapshotDTO) UnmarshalBinary(b []byte) error {
	var res NodeSystemDiagnosticsSnapshotDTO
