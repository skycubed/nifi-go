...
func (m *VariableRegistryDTO) validateVariables(formats strfmt.Registry) error {
...
func (m *VariableRegistryDTO) contextValidateVariables(ctx context.Context, formats strfmt.Registry) error {
