...
func (m *UserEntity) validateBulletins(formats strfmt.Registry) error {
...
func (m *UserEntity) validateComponent(formats strfmt.Registry) error {
...
func (m *UserEntity) validatePermissions(formats strfmt.Registry) error {
...
func (m *UserEntity) validatePosition(formats strfmt.Registry) error {
...
func (m *UserEntity) validateRevision(formats strfmt.Registry) error {
...
func (m *UserEntity) contextValidateBulletins(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UserEntity) contextValidateComponent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UserEntity) contextValidatePermissions(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UserEntity) contextValidatePosition(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UserEntity) contextValidateRevision(ctx context.Context, formats strfmt.Registry) error {
