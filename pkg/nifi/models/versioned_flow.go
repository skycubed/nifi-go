...
// ContextValidate validate this versioned flow based on the context it is used
...
func (m *VersionedFlow) contextValidateBucketName(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VersionedFlow) contextValidateCreatedTimestamp(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VersionedFlow) contextValidateIdentifier(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VersionedFlow) contextValidateModifiedTimestamp(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VersionedFlow) contextValidateVersionCount(ctx context.Context, formats strfmt.Registry) error {
