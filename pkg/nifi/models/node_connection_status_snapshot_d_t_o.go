...
func (m *NodeConnectionStatusSnapshotDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NodeConnectionStatusSnapshotDTO) validateStatusSnapshot(formats strfmt.Registry) error {
...
func (m *NodeConnectionStatusSnapshotDTO) contextValidateStatusSnapshot(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NodeConnectionStatusSnapshotDTO) UnmarshalBinary(b []byte) error {
	var res NodeConnectionStatusSnapshotDTO
