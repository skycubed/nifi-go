...
func (m *JVMFlowDiagnosticsSnapshotDTO) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateBundlesLoaded(formats); err != nil {
		res = append(res, err)
	}
...
func (m *JVMFlowDiagnosticsSnapshotDTO) validateBundlesLoaded(formats strfmt.Registry) error {
	if swag.IsZero(m.BundlesLoaded) { // not required
		return nil
	}

	if err := validate.UniqueItems("bundlesLoaded", "body", m.BundlesLoaded); err != nil {
		return err
	}
	...
	for i := 0; i < len(m.BundlesLoaded); i++ {
		...
		if m.BundlesLoaded[i] != nil {
			if err := m.BundlesLoaded[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("bundlesLoaded" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("bundlesLoaded" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *JVMFlowDiagnosticsSnapshotDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateBundlesLoaded(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *JVMFlowDiagnosticsSnapshotDTO) contextValidateBundlesLoaded(ctx context.Context, formats strfmt.Registry) error {
...
func (m *JVMFlowDiagnosticsSnapshotDTO) UnmarshalBinary(b []byte) error {
	var res JVMFlowDiagnosticsSnapshotDTO
