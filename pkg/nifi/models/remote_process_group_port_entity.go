...
func (m *RemoteProcessGroupPortEntity) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateRemoteProcessGroupPort(formats); err != nil {
		res = append(res, err)
	}
...
func (m *RemoteProcessGroupPortEntity) validateBulletins(formats strfmt.Registry) error {
...
func (m *RemoteProcessGroupPortEntity) validateOperatePermissions(formats strfmt.Registry) error {
...
func (m *RemoteProcessGroupPortEntity) validatePermissions(formats strfmt.Registry) error {
...
func (m *RemoteProcessGroupPortEntity) validatePosition(formats strfmt.Registry) error {
...
func (m *RemoteProcessGroupPortEntity) validateRemoteProcessGroupPort(formats strfmt.Registry) error {
	if swag.IsZero(m.RemoteProcessGroupPort) { // not required
		return nil
	}

	if m.RemoteProcessGroupPort != nil {
		if err := m.RemoteProcessGroupPort.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("remoteProcessGroupPort")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("remoteProcessGroupPort")
			}
			return err
		}
	}
...
func (m *RemoteProcessGroupPortEntity) validateRevision(formats strfmt.Registry) error {
...
func (m *RemoteProcessGroupPortEntity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateRemoteProcessGroupPort(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *RemoteProcessGroupPortEntity) contextValidateBulletins(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RemoteProcessGroupPortEntity) UnmarshalBinary(b []byte) error {
	var res RemoteProcessGroupPortEntity
