...
func (m *FlowRegistryBucketsEntity) validateBuckets(formats strfmt.Registry) error {
...
func (m *FlowRegistryBucketsEntity) contextValidateBuckets(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FlowRegistryBucketsEntity) UnmarshalBinary(b []byte) error {
	var res FlowRegistryBucketsEntity
