...
func (m *ClusterEntity) validateCluster(formats strfmt.Registry) error {
...
func (m *ClusterEntity) contextValidateCluster(ctx context.Context, formats strfmt.Registry) error {
