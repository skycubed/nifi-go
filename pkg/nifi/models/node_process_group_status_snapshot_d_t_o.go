...
func (m *NodeProcessGroupStatusSnapshotDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NodeProcessGroupStatusSnapshotDTO) validateStatusSnapshot(formats strfmt.Registry) error {
...
func (m *NodeProcessGroupStatusSnapshotDTO) UnmarshalBinary(b []byte) error {
	var res NodeProcessGroupStatusSnapshotDTO
