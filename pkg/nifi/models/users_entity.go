...
func (m *UsersEntity) validateUsers(formats strfmt.Registry) error {
...
func (m *UsersEntity) contextValidateUsers(ctx context.Context, formats strfmt.Registry) error {
